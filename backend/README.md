...
- In Postgres mode, charging-session rebuild and charging KPI snapshot recompute run natively; range/composite/temperature KPI and ranking snapshot recompute still use the SQLite bridge path.
