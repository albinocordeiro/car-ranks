...
- In Postgres mode, charging-session rebuild, charging KPI snapshot recompute, and charging ranking snapshot recompute run natively; range/composite/temperature KPI and ranking snapshot recompute still use the SQLite bridge path.
